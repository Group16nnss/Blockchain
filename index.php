                        ...
                        <div class="row">
                            <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                                <div class="animated bounceInDown slider-captions">
                                    <h3 class="slider-title">Giving is the Greatest act of grace </h3>
                    ...
                    <div class="row">
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                            <div class="slider-captions ">
                                <h1 class="slider-title">We rise by lifting others.</h1>
                                <p class="slider-text hidden-xs">-Robert Ingersoll</p>
            ...
            <div class="item">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                            <div class="slider-captions ">
                                <h1 class="slider-title">It is not how we give but how much love we put into giving</h1>
                                <p class="slider-text hidden-xs">Mother Teresa</p>
    ...
    <div class="container">
        ...
        <div class="row natur-row no-margin w-100">
            <div class="text-part col-md-6">
                ...
                <h3 style="text-align:justify"><b>We Believe In The Power Of You</b></h3>
            <p style="text-align:justify">This is where revolutions are born. Where social change 
       begins. This is where you raise awareness and funds.
         Where you change the world. This is your key to tomorrow. </p>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="event-box">
                        <img src="images/img2.jpg" alt="">
                         ...
                         <p class="desic">cancer</p>

                        <p class="raises">Amount  :  60000 </p>
						<p>NGO</p><br>
                        <button class="btn btn-success btn-sm"><a href="login.php">Donate Now</a></button>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="event-box">
                        ...
                        <p class="raises">Amount  :  45000 </p>
						<p>Medical Treatment</p><br>
                        <button class="btn btn-success btn-sm"><a href="login.php">Donate Now</a></button>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="event-box">
                        <img src="images/img4.jpg" alt="">
                         <p class="desic"> Kidney cancer</p>

                        <p class="raises">Amount  :  50000 </p>
						<p>Medical Treatment</p><br>
                        <button class="btn btn-success btn-sm"><a href="login.php">Donate Now</a></button>
                    </div>
                </div>
